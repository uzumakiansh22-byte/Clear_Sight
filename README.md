...
AURA VISION is an **offline assistive smart-glasses prototype** designed to help visually impaired users become more aware of nearby obstacles through **directional vibration feedback and prerecorded audio alerts**.
...
> This repository contains the firmware developed for the current prototype. It is **not the final production version** of the complete AURA VISION system.
...
The final AURA VISION product would require additional sensing and a more advanced perception architecture.
...
AURA VISION currently demonstrates the core concept of an **offline, sensor-based assistive smart-glasses system**.
...
**AURA VISION — Prototype today, expandable assistive platform for the future.**
